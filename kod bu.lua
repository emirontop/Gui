...
function redzlib:MakeWindow(Configs)
	...
	-- BURADAKİ ÖNEMLİ DEĞİŞİKLİK: Window tablosunu burada başlatıyoruz
	-- ve MainFrame'i bu tablonun bir özelliği olarak atıyoruz.
	local Window = {} 
	Window.MainFrame = InsertTheme(Create("ImageButton", ScreenGui, {
		Size = UDim2.fromOffset(UISizeX, UISizeY),
		Position = UDim2.new(0.5, -UISizeX/2, 0.5, -UISizeY/2),
		BackgroundTransparency = 0.03,
		Name = "Hub"
	}), "Main")
	Make("Gradient", Window.MainFrame, { -- MainFrame yerine Window.MainFrame kullanıyoruz
		Rotation = 45
	})MakeDrag(Window.MainFrame) -- MainFrame yerine Window.MainFrame kullanıyoruz
	
	local MainCorner = Make("Corner", Window.MainFrame) -- MainFrame yerine Window.MainFrame kullanıyoruz
	
	local Components = Create("Folder", Window.MainFrame, { -- MainFrame yerine Window.MainFrame kullanıyoruz
		Name = "Components"
	})
	...
	local ControlSize1, ControlSize2 = MakeDrag(Create("ImageButton", Window.MainFrame, { -- MainFrame yerine Window.MainFrame
		Size = UDim2.new(0, 35, 0, 35),
		Position = Window.MainFrame.Size, -- MainFrame yerine Window.MainFrame
		Active = true,
		AnchorPoint = Vector2.new(0.8, 0.8),
		BackgroundTransparency = 1,
		Name = "Control Hub Size"
	})), MakeDrag(Create("ImageButton", Window.MainFrame, { -- MainFrame yerine Window.MainFrame
	...
	local function ControlSize()
		...
		Window.MainFrame.Size = ControlSize1.Position -- MainFrame yerine Window.MainFrame
	end
	...
	ConnectSave(ControlSize1, function()
		if not Minimized then
			redzlib.Save.UISize = {Window.MainFrame.Size.X.Offset, Window.MainFrame.Size.Y.Offset} -- MainFrame yerine Window.MainFrame
			SaveJson("redz library V5.json", redzlib.Save)
		end
	end)
	...
	-- local Window, FirstTab = {}, false -- Bu satır artık gerekli değil, yukarıda Window'u başlattık
	local FirstTab = false -- Sadece FirstTab'i tutuyoruz
	...
	function Window:MinimizeBtn()
		...
		if Minimized then
			...
			CreateTween({Window.MainFrame, "Size", SaveSize, 0.25, true}) -- MainFrame yerine Window.MainFrame
			ControlSize1.Visible = true
			ControlSize2.Visible = true
			Minimized = false
		else
			MinimizeButton.Image = "rbxassetid://10734924532"
			SaveSize = Window.MainFrame.Size -- MainFrame yerine Window.MainFrame
			ControlSize1.Visible = false
			ControlSize2.Visible = false
			CreateTween({Window.MainFrame, "Size", UDim2.fromOffset(Window.MainFrame.Size.X.Offset, 28), 0.25, true}) -- MainFrame yerine Window.MainFrame
			Minimized = true
		end
	...
	function Window:Minimize()
		Window.MainFrame.Visible = not Window.MainFrame.Visible -- MainFrame yerine Window.MainFrame
	end
	...
	function Window:Dialog(Configs)
		if Window.MainFrame:FindFirstChild("Dialog") then return end -- MainFrame yerine Window.MainFrame
		if Minimized then
			Window:MinimizeBtn()
		end
		...
		local Screen = InsertTheme(Create("Frame", Window.MainFrame, { -- MainFrame yerine Window.MainFrame
	...
	function Window:MakeTab(paste, Configs)
		...
		function Tab:AddDropdown(Configs)
			...
			Window.MainFrame:GetPropertyChangedSignal("Visible"):Connect(Disable) -- MainFrame yerine Window.MainFrame
    ...
    function Window:SetVisible(state)
        -- self.MainFrame'e eriştiğimizden emin oluyoruz
