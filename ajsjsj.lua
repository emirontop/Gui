...
Discord:AddDiscordInvite({
   ...
   Description = "Join our discord community to receive information about the nextupdate",
...
                 else
        ...
        while getgenv().AutoFarmRaid do task.wait()
          if Configure("Raid") then
            ...
            if not Player.PlayerGui.Main.Timer.Visible and VerifyTool("Special") then
